 ...
 * @since      v0.0.1
 *
 * This interface simply compains the resolver and the table,
 * because both components make up a full fledged router
 *
 */

namespace  TakeMyHand\Routing;

interface IRouter extends IRouteResolver, IRouteTable{
